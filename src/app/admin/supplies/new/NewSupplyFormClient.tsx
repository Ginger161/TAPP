    ...
    <form action={handleSubmit} className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <input required id="quantity" name="quantity" type="number" inputMode="decimal" pattern="[0-9]*" step="0.01" min="0" className="w-full px-3 py-2 border rounded-lg dark:bg-gray-800 dark:border-gray-700 outline-none focus:ring-2 focus:ring-tycoon-red" />
        </div>

        <div>
          <label className="block text-sm font-medium mb-1.5" htmlFor="costPrice">Total Cost Price (₦)</label>
          <input required id="costPrice" name="costPrice" type="number" inputMode="decimal" pattern="[0-9]*" step="0.01" min="0" className="w-full px-3 py-2 border rounded-lg dark:bg-gray-800 dark:border-gray-700 outline-none focus:ring-2 focus:ring-tycoon-red" />
        </div>
      </div>
