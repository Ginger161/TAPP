    ...
    <div className="bg-tycoon-navy text-white p-4 shadow-md sticky top-0 z-[60] flex justify-between items-center shrink-0">
      <div className="flex items-center gap-6">
        <Link href="/viewer/dashboard" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
          ...
          <span className="bg-gray-500 text-white text-xs px-2 py-0.5 rounded-full ml-1 align-middle">Viewer</span>
        </Link>
        ...
        <nav className="hidden md:flex items-center gap-4 ml-6 border-l border-gray-600 pl-6">
          <Link 
            ...
            className={`flex items-center gap-2 px-3 py-2 rounded-md transition-colors ${
              pathname === '/viewer/dashboard' ? 'bg-white/10 text-white font-medium' : 'text-gray-300 hover:bg-white/5 hover:text-white'
            }`}
          >
          ...
          <Link 
            ...
            className={`flex items-center gap-2 px-3 py-2 rounded-md transition-colors ${
              pathname?.startsWith('/viewer/analytics') ? 'bg-white/10 text-white font-medium' : 'text-gray-300 hover:bg-white/5 hover:text-white'
            }`}
          >
            <BarChart3 size={18} />
            <span>Analytics</span>
